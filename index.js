/**
 * HybridTV
 * Version: 1.0.6 (Stabilité Origine, Tri d'Origine & Corrections Chirurgicales Canal)
 */
...
// --- SEMANTIC ROUTING (ORIGINAL RESTORÉ AVEC ISOLATION CHIRURGICALE DES EXCEPTIONS) ---
function getChannelData(rawName) {
    ...
    // --- EXCEPTIONS STRICTES (ISOLATION DES CHAÎNES CONTENANT "CANAL" MAIS HORS BOUQUET) ---
...
// --- CATALOG ENGINE UNIVERSEL (ORIGINAL RESTORÉ) ---
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p class="subtitle">L'expérience IPTV centralisée, synchrone et optimisée (v1.0.6)</p>
            </div>
...
app.get('/:config/manifest.json', (req, res) => {
    ...
    res.json({
        ...
        version: '1.0.6',
        name: 'HybridTV',
        description: 'Meta-Addon IPTV Sécurisé (v1.0.6).',
...
app.get('/:config/stream/tv/:id.json', async (req, res) => {
    ...
    try {
        ...
        // --- RESTAURATION DU TRI PAR SCORE D'ORIGINE ---
...
app.listen(PORT, async () => {
    console.log(`[INFO] Server started on port ${PORT} (HybridTV v1.0.6 STABLE)`);
    updateEPG(); 
