 ...
 * Core Engine: Permanent Stream Scanner (2s Ping), 5s Micro-Cache, Absolute Semantic Routing.
 */
...
function getChannelData(rawName) {
    ...
    if (c.includes('CANAL') || c.includes('CPLUS')) {
        // L'EXIL DE CANAL+ ELLES (Totalement isolé en bas)
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p class="subtitle">L'expérience IPTV centralisée, triée et optimisée (v1.0.0).</p>
            </div>
...
app.get('/:config/manifest.json', (req, res) => {
    ...
    res.json({
        ...
        version: '1.0.0',
        name: 'HybridTV',
        description: 'Meta-Addon IPTV (v1.0). Live Scanner, Opti-Cache & Strict Routing.',
...
app.get('/:config/stream/tv/:id.json', async (req, res) => {
    ...
    try {
        ...
        // --- SCANNER DE LIENS MORTS PERMANENT (Ping Opti 2s) ---
